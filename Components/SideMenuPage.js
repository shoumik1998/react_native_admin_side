...
const SideMenuPage = () => { // Side Menu Page component
    return (
        <NativeBaseProvider>
            <View style={{ flex: 10, marginRight: "10%", backgroundColor: "white" }}>
                <View style={{
                    flex: 3, backgroundColor: "red", justifyContent: "center", alignItems: "center",
                ...
                <View style={{ flex: 7, justifyContent: 'space-evenly', backgroundColor: "white" }}>
                    <TouchableOpacity onPress={() => { Transition.go("AllProducts", "homeScreenID", 0) }}>
                    ...
                    <TouchableOpacity onPress={() => { Transition.go("AllProducts", "homeScreenID", 1) }}>
                        <View style={styles.viewStyles}>
